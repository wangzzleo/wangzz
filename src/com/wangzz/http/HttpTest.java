...
public class HttpTest {
    public static void main(String[] args) {
        int i = 0;
        while (true) {
            String url = "https://hanyu.baidu.com/hanyu/ajax/search_list?wd=%E4%BA%94%E8%A1%8C%E5%B1%9E%E6%B0%B4%E7%9A%84%E5%AD%97&from=poem&userid=238816338&pn="+(++i)+"&_=1555660507607";
...
//        pairList.add(new BasicNameValuePair("_","1555659896268"));
            ...
            JSONArray retArray = JSON.parseObject(s).getJSONArray("ret_array");
            retArray.forEach((j) -> System.out.print("子"+((JSONObject)j).get("name").toString().charAt(2)+","));
        }
